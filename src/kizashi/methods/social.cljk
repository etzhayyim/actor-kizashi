(ns kizashi.methods.social
  "social.cljc — 兆 — Non-invasive Multimodal Body-Scan / Sign-Sensing DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kizashi's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "兆 — Non-invasive Multimodal Body-Scan / Sign-Sensing が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over kizashi's own domain (Non-profit religious-corp non-invasive multimodal body-scan / sign-sensing substrate — the 'futuristic scan pod' sensing/instrument layer…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kizashi R0: live social posting is Council Lv6+ + operator + "

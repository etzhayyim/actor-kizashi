(ns kizashi.cells.social-post.state-machine
  "Phase state machine for the 兆 — Non-invasive Multimodal Body-Scan / Sign-Sensing social_post cell — the publication membrane that
